...
public class ExcelToAvroConverter {
    public static void convert(File excelFile, OutputStream avroOutputStream, String sheetName, int col, int row, Schema schema) throws IOException {
        ...
        ExcelToAvro excelToAvro = new ExcelToAvro(excelSheetReader, schema, headerInfo, col, row + headerInfo.rowSpan);
