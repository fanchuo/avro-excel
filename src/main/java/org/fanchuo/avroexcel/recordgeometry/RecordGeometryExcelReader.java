...
public class RecordGeometryExcelReader {
    ...
    public static RecordGeometry visitSheet(ExcelSheetReader sheet, int col, int row, HeaderInfo headerInfo) {
    ...
    private static RecordGeometry visitCollection(ExcelSheetReader sheet, int row, int collectionSize, CollectionDescriptor collectionDescriptor) {
        List<RecordGeometry> subList = new ArrayList<>();
        int rowIdx = row;
        int rowSpan = 0;
        for (int i = 0; i< collectionSize; i++) {
            RecordGeometry entry = visitSheet(sheet, collectionDescriptor.col, rowIdx, collectionDescriptor.headerInfo);
